let is_mobiles = navigator.userAgent.toLowerCase().match(/(ipod|iphone|android|coolpad|mmp|smartphone|midp|wap|xoom|symbian|j2me|blackberry|wince)/i) != null; 
if(is_mobiles){  //判断是否为移动端
  if( window.location.host != 'm.ts136.com' ){
    window.location = 'https://m.ts136.com' + window.location.pathname; //带路径跳转
  }
}
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?88a4aac1db4006709f8d3a8b0d3303e0";
...
cnzz_s_tag.src = 'https://w.cnzz.com/c.php?id=1278658101&async=1';
