        ...
        'pre'     : function () {//代码高亮
            ...
            if ($("pre code").length) {
                ...
                $("<link>").attr({
                    rel : "stylesheet",
                    type: "text/css",
                    href: "/Public/cdn/highlight/highlight.min.css"
                }).appendTo("head");
    ...
    'score'   : {//评分
        'raty': function () {
            if ($('.ff-score').length) {
                ...
                // "//cdn.bootcss.com/raty/2.7.1/jquery.raty.min.css"}).appendTo("head");
...
//				$id = $(".ff-share");
//			}
//			$($id).html('<div class="bdsharebuttonbox"><a href="#" class="bds_qzone" data-cmd="qzone"
// title="分享到QQ空间"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a><a href="#" class="bds_sqq"
// data-cmd="sqq" title="分享到QQ好友"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#"
// class="bds_copy" data-cmd="copy" title="分享到复制网址"></a><a href="#" class="bds_more" data-cmd="more"></a></div>');
// window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":""+$size+""},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='//bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new
// Date()/36e5)]; } } },
    'forum'   : {//讨论模块功能
        'load'    : function () {
                ...
                $.post($this.attr('action'), $this.serialize(), function (json) {
                    if (json.status == 200) {//不需要审核留言
                        ...
                        if (json.data.forum_pid) {//回复贴
                            ...
                            setTimeout(function () {
                                feifei.forum.ajax('.ff-forum-item', json.data.forum_sid, json.data.forum_cid, 1, 1)
                            }, 2000);
                            setTimeout(function () {
                                $this.hide()
                            }, 3000);
    ...
    'scenario': {//分集剧情
        'load': function () {
            ...
            var obj = $('.detail .detail-tab li');
            if (obj.length > 0) {
                $(obj[0]).find('a').tab('show');
            }
        }
    },
    'playurl' : {//播放地址
